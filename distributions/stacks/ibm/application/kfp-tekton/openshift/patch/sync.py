    ...
    def sync(self, parent, children):
        ...
        desired_status = {
            "kubeflow-pipelines-ready": \
                ...
                len(children["SecurityContextConstraints.security.openshift.io/v1"]) == 2 and \
        ...
        desired_resources = [
            ...
            },
            {
                ...
                "metadata": {
                    "annotations": {
                        "kubernetes.io/description": "add privilege to user namespaces"
                    },
                ...
                "allowedCapabilities": "false",
                "defaultAddCapabilities": "false",
                "fsGroup": {
                    "type": "RunAsAny"
                },
                "groups": [
                ...
                "users": [
                    ...
                    "system:serviceaccount:"+namespace+":default-editor",
                    "system:serviceaccount:"+namespace+":default-viewer"
                ],
                "volumes": [
                    "configMap",
                    "downwardAPI",
